                    ...
                    <article className="w-full h-full flex justify-between items-center  ">
                        ...
                        <div className="flex gap-4">
                            ...
                            <a href="https://www.instagram.com/siko_mobility?igsh=MTlyZDUzYXlubXZvaA==" target="_blank">
                                <svg xmlns="http://www.w3.org/2000/svg"fill="currentColor"className="text-instaColor bi bi-instagram hover:text-[rgb(131,58,180)] scale-100 hover:scale-[1.2] duration-200 ease-in-out w-5 h-5"viewBox="0 0 16 16">
